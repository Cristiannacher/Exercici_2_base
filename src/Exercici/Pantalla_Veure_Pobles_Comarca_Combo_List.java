...
public class Pantalla_Veure_Pobles_Comarca_Combo_List extends JFrame implements ActionListener, ListSelectionListener {
    ...
    private void connexio() throws SQLException {
    ...
    private void agafarComarques() throws SQLException {
    ...
    private void visualitzaCom(String comarca) {
        ...
        String sql = "SELECT nom FROM POBLACIONS" +" WHERE nom_c = '" +comarca.replaceAll("'","''")+ "' order by 1";
